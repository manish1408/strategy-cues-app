...
export class RevenueComponent implements OnInit {
  ...
  filterData(): void {
    ...
    this.filteredData = dataSource.filter(item => {
      ...
      const matchesRevparMin = this.revparMin === null || revparTM >= this.revparMin;
      const matchesRevparMax = this.revparMax === null || revparTM <= this.revparMax;
      const matchesMpiMin = this.mpiMin === null || mpi >= this.mpiMin;
      const matchesMpiMax = this.mpiMax === null || mpi <= this.mpiMax;
      const matchesMinRateThresholdMin = this.minRateThresholdMin === null || minRateThreshold >= this.minRateThresholdMin;
      const matchesMinRateThresholdMax = this.minRateThresholdMax === null || minRateThreshold <= this.minRateThresholdMax;

      // Occupancy filters
      const matchesOccupancyTMMin = this.occupancyTMMin === null || occupancyTM >= this.occupancyTMMin;
      const matchesOccupancyTMMax = this.occupancyTMMax === null || occupancyTM <= this.occupancyTMMax;
      const matchesOccupancyNMMin = this.occupancyNMMin === null || occupancyNM >= this.occupancyNMMin;
      const matchesOccupancyNMMax = this.occupancyNMMax === null || occupancyNM <= this.occupancyNMMax;
      const matchesOccupancy7DaysMin = this.occupancy7DaysMin === null || occupancy7Days >= this.occupancy7DaysMin;
      const matchesOccupancy7DaysMax = this.occupancy7DaysMax === null || occupancy7Days <= this.occupancy7DaysMax;
      const matchesOccupancy30DaysMin = this.occupancy30DaysMin === null || occupancy30Days >= this.occupancy30DaysMin;
      const matchesOccupancy30DaysMax = this.occupancy30DaysMax === null || occupancy30Days <= this.occupancy30DaysMax;
      const matchesPickUpOcc7DaysMin = this.pickUpOcc7DaysMin === null || pickUpOcc7Days >= this.pickUpOcc7DaysMin;
      const matchesPickUpOcc7DaysMax = this.pickUpOcc7DaysMax === null || pickUpOcc7Days <= this.pickUpOcc7DaysMax;
      const matchesPickUpOcc14DaysMin = this.pickUpOcc14DaysMin === null || pickUpOcc14Days >= this.pickUpOcc14DaysMin;
      const matchesPickUpOcc14DaysMax = this.pickUpOcc14DaysMax === null || pickUpOcc14Days <= this.pickUpOcc14DaysMax;
      const matchesPickUpOcc30DaysMin = this.pickUpOcc30DaysMin === null || pickUpOcc30Days >= this.pickUpOcc30DaysMin;
      const matchesPickUpOcc30DaysMax = this.pickUpOcc30DaysMax === null || pickUpOcc30Days <= this.pickUpOcc30DaysMax;

      // Performance filters (STLY Var)
      const matchesStlyVarOccMin = this.stlyVarOccMin === null || stlyVarOcc >= this.stlyVarOccMin;
      const matchesStlyVarOccMax = this.stlyVarOccMax === null || stlyVarOcc <= this.stlyVarOccMax;
      const matchesStlyVarADRMin = this.stlyVarADRMin === null || stlyVarADR >= this.stlyVarADRMin;
      const matchesStlyVarADRMax = this.stlyVarADRMax === null || stlyVarADR <= this.stlyVarADRMax;
      const matchesStlyVarRevPARMin = this.stlyVarRevPARMin === null || stlyVarRevPAR >= this.stlyVarRevPARMin;
      const matchesStlyVarRevPARMax = this.stlyVarRevPARMax === null || stlyVarRevPAR <= this.stlyVarRevPARMax;

      // Performance filters (STLM Var)
      const matchesStlmVarOccMin = this.stlmVarOccMin === null || stlmVarOcc >= this.stlmVarOccMin;
      const matchesStlmVarOccMax = this.stlmVarOccMax === null || stlmVarOcc <= this.stlmVarOccMax;
      const matchesStlmVarADRMin = this.stlmVarADRMin === null || stlmVarADR >= this.stlmVarADRMin;
      const matchesStlmVarADRMax = this.stlmVarADRMax === null || stlmVarADR <= this.stlmVarADRMax;
      ...
      const matchesBookingRevScoreMax = this.bookingRevScoreMax === null || bookingRevScore <= this.bookingRevScoreMax;
      const matchesBookingTotalRevMin = this.bookingTotalRevMin === null || bookingTotalRev >= this.bookingTotalRevMin;
      const matchesBookingTotalRevMax = this.bookingTotalRevMax === null || bookingTotalRev <= this.bookingTotalRevMax;

      // Reviews filters - Airbnb
      const matchesAirbnbRevScoreMin = this.airbnbRevScoreMin === null || airbnbRevScore >= this.airbnbRevScoreMin;
      const matchesAirbnbRevScoreMax = this.airbnbRevScoreMax === null || airbnbRevScore <= this.airbnbRevScoreMax;
      const matchesAirbnbTotalRevMin = this.airbnbTotalRevMin === null || airbnbTotalRev >= this.airbnbTotalRevMin;
      const matchesAirbnbTotalRevMax = this.airbnbTotalRevMax === null || airbnbTotalRev <= this.airbnbTotalRevMax;

      // Reviews filters - VRBO
      const matchesVrboRevScoreMin = this.vrboRevScoreMin === null || vrboRevScore >= this.vrboRevScoreMin;
      const matchesVrboRevScoreMax = this.vrboRevScoreMax === null || vrboRevScore <= this.vrboRevScoreMax;
      const matchesVrboTotalRevMin = this.vrboTotalRevMin === null || vrboTotalRev >= this.vrboTotalRevMin;
      const matchesVrboTotalRevMax = this.vrboTotalRevMax === null || vrboTotalRev <= this.vrboTotalRevMax;

      return matchesSearch && matchesArea && matchesRoomType &&
             // Basic filters
             matchesAdrMin && matchesAdrMax &&
             matchesRevparMin && matchesRevparMax &&
             matchesMpiMin && matchesMpiMax &&
             matchesMinRateThresholdMin && matchesMinRateThresholdMax &&
             // Occupancy filters
             matchesOccupancyTMMin && matchesOccupancyTMMax &&
             matchesOccupancyNMMin && matchesOccupancyNMMax &&
             matchesOccupancy7DaysMin && matchesOccupancy7DaysMax &&
             matchesOccupancy30DaysMin && matchesOccupancy30DaysMax &&
             matchesPickUpOcc7DaysMin && matchesPickUpOcc7DaysMax &&
             matchesPickUpOcc14DaysMin && matchesPickUpOcc14DaysMax &&
             matchesPickUpOcc30DaysMin && matchesPickUpOcc30DaysMax &&
             // Performance filters
             matchesStlyVarOccMin && matchesStlyVarOccMax &&
             matchesStlyVarADRMin && matchesStlyVarADRMax &&
             matchesStlyVarRevPARMin && matchesStlyVarRevPARMax &&
             matchesStlmVarOccMin && matchesStlmVarOccMax &&
             matchesStlmVarADRMin && matchesStlmVarADRMax &&
             matchesStlmVarRevPARMin && matchesStlmVarRevPARMax &&
             // Platform filters
             matchesBookingGenius && matchesBookingMobile && matchesBookingPref &&
             matchesBookingWeekly && matchesBookingMonthly && matchesBookingLMDisc &&
             matchesAirbnbWeekly && matchesAirbnbMonthly && matchesAirbnbMember && matchesAirbnbLMDisc &&
             matchesVrboWeekly && matchesVrboMonthly &&
             // Reviews filters
             matchesBookingRevScoreMin && matchesBookingRevScoreMax &&
             matchesBookingTotalRevMin && matchesBookingTotalRevMax &&
             matchesAirbnbRevScoreMin && matchesAirbnbRevScoreMax &&
             matchesAirbnbTotalRevMin && matchesAirbnbTotalRevMax &&
             matchesVrboRevScoreMin && matchesVrboRevScoreMax &&
             matchesVrboTotalRevMin && matchesVrboTotalRevMax;
    });
  ...
  getStarArray(rating: string | number, maxRating: number): Array<{filled: boolean}> {
  ...
  hasActiveFilters(): boolean {
    return !!(this.selectedArea || this.selectedRoomType || 
              // Basic filters
              this.adrMin !== null || this.adrMax !== null ||
              this.revparMin !== null || this.revparMax !== null ||
              this.mpiMin !== null || this.mpiMax !== null ||
              this.minRateThresholdMin !== null || this.minRateThresholdMax !== null ||
              // Occupancy filters
              this.occupancyTMMin !== null || this.occupancyTMMax !== null ||
              this.occupancyNMMin !== null || this.occupancyNMMax !== null ||
              this.occupancy7DaysMin !== null || this.occupancy7DaysMax !== null ||
              this.occupancy30DaysMin !== null || this.occupancy30DaysMax !== null ||
              this.pickUpOcc7DaysMin !== null || this.pickUpOcc7DaysMax !== null ||
              this.pickUpOcc14DaysMin !== null || this.pickUpOcc14DaysMax !== null ||
              this.pickUpOcc30DaysMin !== null || this.pickUpOcc30DaysMax !== null ||
              // Performance filters
              this.stlyVarOccMin !== null || this.stlyVarOccMax !== null ||
              this.stlyVarADRMin !== null || this.stlyVarADRMax !== null ||
              this.stlyVarRevPARMin !== null || this.stlyVarRevPARMax !== null ||
              ...
              this.airbnbRevScoreMin !== null || this.airbnbRevScoreMax !== null ||
              this.airbnbTotalRevMin !== null || this.airbnbTotalRevMax !== null ||
              this.vrboRevScoreMin !== null || this.vrboRevScoreMax !== null ||
              this.vrboTotalRevMin !== null || this.vrboTotalRevMax !== null);
  }
  ...
  getActiveFilterCount(): number {
    ...
    if (this.minRateThresholdMin !== null || this.minRateThresholdMax !== null) count++;
    
    // Occupancy filters
    if (this.occupancyTMMin !== null || this.occupancyTMMax !== null) count++;
    if (this.occupancyNMMin !== null || this.occupancyNMMax !== null) count++;
    if (this.occupancy7DaysMin !== null || this.occupancy7DaysMax !== null) count++;
    if (this.occupancy30DaysMin !== null || this.occupancy30DaysMax !== null) count++;
    if (this.pickUpOcc7DaysMin !== null || this.pickUpOcc7DaysMax !== null) count++;
    if (this.pickUpOcc14DaysMin !== null || this.pickUpOcc14DaysMax !== null) count++;
    if (this.pickUpOcc30DaysMin !== null || this.pickUpOcc30DaysMax !== null) count++;
    
    // Performance filters
    if (this.stlyVarOccMin !== null || this.stlyVarOccMax !== null) count++;
    if (this.stlyVarADRMin !== null || this.stlyVarADRMax !== null) count++;
    if (this.stlyVarRevPARMin !== null || this.stlyVarRevPARMax !== null) count++;
    ...
    if (this.bookingTotalRevMin !== null || this.bookingTotalRevMax !== null) count++;
    if (this.airbnbRevScoreMin !== null || this.airbnbRevScoreMax !== null) count++;
    if (this.airbnbTotalRevMin !== null || this.airbnbTotalRevMax !== null) count++;
  ...
  getAppliedFilters(): Array<{type: string, label: string, value: string, key: string}> {
    const filters: Array<{type: string, label: string, value: string, key: string}> = [];

    // Basic filters
    if (this.selectedArea) {
      filters.push({type: 'basic', label: 'Area', value: this.selectedArea, key: 'selectedArea'});
    }
    if (this.selectedRoomType) {
      filters.push({type: 'basic', label: 'Room Type', value: this.selectedRoomType, key: 'selectedRoomType'});
    }
    if (this.adrMin !== null || this.adrMax !== null) {
      const value = `$${this.adrMin || this.adrMinRange} - $${this.adrMax || this.adrMaxRange}`;
      filters.push({type: 'range', label: 'ADR Range', value: value, key: 'adr'});
    }
    if (this.revparMin !== null || this.revparMax !== null) {
      const value = `$${this.revparMin || this.revparMinRange} - $${this.revparMax || this.revparMaxRange}`;
      filters.push({type: 'range', label: 'RevPAR Range', value: value, key: 'revpar'});
    }
    if (this.mpiMin !== null || this.mpiMax !== null) {
      const value = `${this.mpiMin || this.mpiMinRange}% - ${this.mpiMax || this.mpiMaxRange}%`;
      filters.push({type: 'range', label: 'MPI Range', value: value, key: 'mpi'});
    }
    if (this.minRateThresholdMin !== null || this.minRateThresholdMax !== null) {
      const value = `${this.minRateThresholdMin || 0}% - ${this.minRateThresholdMax || 100}%`;
      filters.push({type: 'range', label: 'Min Rate Threshold', value: value, key: 'minRateThreshold'});
    }

    // Occupancy filters
    if (this.occupancyTMMin !== null || this.occupancyTMMax !== null) {
      const value = `${this.occupancyTMMin || 0}% - ${this.occupancyTMMax || 100}%`;
      filters.push({type: 'range', label: 'Occupancy TM', value: value, key: 'occupancyTM'});
    }
    if (this.occupancyNMMin !== null || this.occupancyNMMax !== null) {
      const value = `${this.occupancyNMMin || 0}% - ${this.occupancyNMMax || 100}%`;
      filters.push({type: 'range', label: 'Occupancy NM', value: value, key: 'occupancyNM'});
    }
    if (this.occupancy7DaysMin !== null || this.occupancy7DaysMax !== null) {
      const value = `${this.occupancy7DaysMin || 0}% - ${this.occupancy7DaysMax || 100}%`;
      filters.push({type: 'range', label: 'Occupancy 7 Days', value: value, key: 'occupancy7Days'});
    }
    if (this.occupancy30DaysMin !== null || this.occupancy30DaysMax !== null) {
      const value = `${this.occupancy30DaysMin || 0}% - ${this.occupancy30DaysMax || 100}%`;
      filters.push({type: 'range', label: 'Occupancy 30 Days', value: value, key: 'occupancy30Days'});
    }

    // Performance filters
    if (this.stlyVarOccMin !== null || this.stlyVarOccMax !== null) {
      const value = `${this.stlyVarOccMin || this.stlyVarOccMinRange}% - ${this.stlyVarOccMax || this.stlyVarOccMaxRange}%`;
      filters.push({type: 'range', label: 'STLY Var Occ', value: value, key: 'stlyVarOcc'});
    }
    if (this.stlyVarADRMin !== null || this.stlyVarADRMax !== null) {
      const value = `${this.stlyVarADRMin || this.stlyVarADRMinRange}% - ${this.stlyVarADRMax || this.stlyVarADRMaxRange}%`;
      filters.push({type: 'range', label: 'STLY Var ADR', value: value, key: 'stlyVarADR'});
    }
    if (this.stlyVarRevPARMin !== null || this.stlyVarRevPARMax !== null) {
      const value = `${this.stlyVarRevPARMin || this.stlyVarRevPARMinRange}% - ${this.stlyVarRevPARMax || this.stlyVarRevPARMaxRange}%`;
    ...
    if (this.bookingRevScoreMin !== null || this.bookingRevScoreMax !== null) {
      const value = `${this.bookingRevScoreMin || 0} - ${this.bookingRevScoreMax || 10}`;
      filters.push({type: 'range', label: 'Booking Review Score', value: value, key: 'bookingRevScore'});
    }
    if (this.airbnbRevScoreMin !== null || this.airbnbRevScoreMax !== null) {
      const value = `${this.airbnbRevScoreMin || 0} - ${this.airbnbRevScoreMax || 5}`;
      filters.push({type: 'range', label: 'Airbnb Review Score', value: value, key: 'airbnbRevScore'});
    }
